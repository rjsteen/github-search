...
Make sure you set up these environment variables with valid a GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET keys in your GitHub account by registering an application.  
